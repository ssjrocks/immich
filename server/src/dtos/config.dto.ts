...
import {
  ...
  VideoFaceSamplingMethodSchema,
  VideoFaceScanMode,
  VideoFaceScanModeSchema,
} from 'src/enum';
  ...
  .object({
    ...
    job: z
      .object({
        ...
        videoFaceDetection: AdminConfigJobSettingsSchema,
        ...
        subtitles: AdminConfigJobSettingsSchema,
      ...
      .object({
        ...
        facialRecognition: AdminConfigMachineLearningModelSchema.extend({
          ...
          video: z
            ...
            .meta({ id: 'AdminConfigVideoFacialRecognitionDto' }),
        ...
        subtitles: AdminConfigMachineLearningModelSchema.meta({ id: 'AdminConfigSubtitlesDto' }),
      })
...
export const defaults = Object.freeze<SystemConfig>({
  ...
  job: {
    ...
    videoFaceDetection: { concurrency: 1 },
